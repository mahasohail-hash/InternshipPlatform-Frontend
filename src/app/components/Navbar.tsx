...
import { Button, Menu, Layout, Space, Avatar, Typography } from 'antd';
import Link from 'next/link';
import { LogoutOutlined, UserOutlined } from '@ant-design/icons';
import { UserRole } from '@/common/enums/user-role.enum'; // Adjust import path
...
export default function AppHeader() {
  ...
  const renderMenuItems = () => {
    ...
    if (!session?.user?.role) return items;
